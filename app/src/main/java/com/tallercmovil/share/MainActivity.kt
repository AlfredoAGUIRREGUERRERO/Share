package com.tallercmovil.share
...
class MainActivity : AppCompatActivity() {
    ...
    private val gallery: ActivityResultLauncher<Intent> = registerForActivityResult(
        ...
        ActivityResultCallback {
            ...
            if(it.resultCode == Activity.RESULT_OK){  //Se seleccionó una imagen exitosamente
                ...
                var ivShareImage = findViewById<ImageView>(R.id.ivShareImage)
    ...
    private fun customizeContentUri(): Uri?{
        ...
        try{
            imagesFolder.mkdirs()
            val file = File(imagesFolder, "imagen_compartida.jpg") //Se le da nombre al contenido a compartir
